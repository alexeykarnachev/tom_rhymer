...
class Rhymer:
    ...
    def __init__(self):
        self._left_tree = Tree()
        self._right_tree = Tree()
        self._words = []
    ...
    def _get_rhymes(
        ...
        all_rhymes = set(left_rhymes) & set(right_rhymes)
    ...
    def get_rhymes_by_scheme(self, scheme, n_attempts=20):
        rhymes = None
    ...
    def try_get_rhymes_by_scheme(self, scheme, min_n_matches, max_n_skips):
    ...
    def get_rhymes(self, seen_words: Sequence[Word]):
        rhymes = set()
        word = seen_words[-1]
...
def _get_phonemes_signatures(phonemes):
    stress_idx = None
